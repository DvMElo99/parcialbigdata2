...
s3.download_file("parcial02bigdata","news/raw/{}".format(key1),new_ubi)
if (key1=="eltiempo.txt"):
  ...
  line1.close()
  line1csv.close()
  s3.upload_file("/tmp/doc1sv.txt","parcial02bigdata","headlines/final/periodico=eltiempo/year={}/month={}/day={}/eltiempo.csv".format(ahora.year,meses[ahora.month-1],ahora.day))
  s3.upload_file(new_ubi,"parcial02bigdata","eltiempo.txt")
s3.download_file("parcial02bigdata","news/raw/{}".format(key2),new_ubi2)
if (key2=="elespectador.txt"):
  ...
  line.close()
  linecsv.close()
  s3.upload_file("/tmp/docsv.txt","parcial02bigdata","headlines/final/periodico=elespectador/year={}/month={}/day={}/elespectador.csv".format(ahora.year,meses[ahora.month-1],ahora.day))
  s3.upload_file("/tmp/doc.txt","parcial02bigdata","elespectador.txt")
  line.close()
